          ...
          <div class="form-group">
            <label>Lokasi</label><br>
              <select class="form-control" name="lokasi" id="lokasi" style="width: 100%;">
                ...
                <option value="001">TPN CKD</option>
                <option value="609">--TPK 21 CKD</option>
                <option value="002">TPN USP</option>
                <option value="603">--TPK 31 USP</option>
                <option value="605">--TPK 24 USP</option>                    
                <option value="610">--TPK MADI DRT</option>
                <option value="611">--TPK MADI AIR</option>
                <option value="710">LP BERE DRT</option>
                <option value="711">LP BERE AIR</option>
                <option value="720">TEMPUNAK</option>
                <option value="740">TAYAN</option>
              </select>
          </div>
        </div>
        <div class="col-sm-3">
