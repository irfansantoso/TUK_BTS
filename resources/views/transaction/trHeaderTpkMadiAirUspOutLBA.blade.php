...
<!-- Content Header (Page header) -->
    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" action="{{ route('trHeaderTpkMadiAirUspOutLBA.add') }}" method="POST">
         @csrf        
        <div class="card-body">          
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                <label>No TPN</label>
                  <input type="text" class="form-control" id="no_tpn_out" name="no_tpn_out" placeholder="" value="TMA/USP/{{ App\Http\Controllers\UserController::getNewNoTpkOut('611'); }}-OUT">
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label>Lokasi</label>                
                  ...
                  <input type="hidden" name="lokasi_tpn" id="lokasi_tpn" value="611">                
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
                <label>Tujuan</label>                
                  <input type="text" class="form-control" name="" value="LP Bere Air" disabled>
    ...
    <div class="card">
      <!-- /.card-header -->
      <div class="card-body">
        <table id="trHeaderUspMadiAirOutLBA" class="table table-bordered table-striped">
          <thead>
          <tr>
            <th>No TPN Out</th>
            <th>Tanggal</th>
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trHeaderTpkMadiAirUspOutLBADestroy.del') }}" method="post">
                  {{ csrf_field() }}
