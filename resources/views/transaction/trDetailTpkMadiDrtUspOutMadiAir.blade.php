...
{{-- <section class="content-header">
  <div class="container-fluid">
    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" action="{{ route('trDetailTpkMadiDrtUspOutMadiAir.add') }}" method="POST">
         @csrf
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trDetailTpkMadiDrtUspOutMadiAir.del') }}" method="post">
                  {{ csrf_field() }}
