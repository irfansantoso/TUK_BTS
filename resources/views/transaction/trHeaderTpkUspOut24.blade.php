...
<!-- Content Header (Page header) -->
    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" action="{{ route('trHeaderTpkUspOut24.add') }}" method="POST">
         @csrf        
        <div class="card-body">          
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                <label>No TPN</label>
                  <input type="text" class="form-control" id="no_tpn_out" name="no_tpn_out" placeholder="" value="T31/USP/{{ App\Http\Controllers\UserController::getNewNoTpkOut('603'); }}-OUT">
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label>Lokasi</label>                
                  <input type="text" class="form-control" name="" value="TPK 31" disabled>
                  <input type="hidden" name="lokasi_tpn" id="lokasi_tpn" value="603">                
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
                <label>Tujuan</label>                
                  <input type="text" class="form-control" name="" value="TPK 24" disabled>
                  <input type="hidden" name="tujuan" id="tujuan" value="605">                
              </div>
            </div>
    ...
    <div class="card">
      <!-- /.card-header -->
      <div class="card-body">
        <table id="trHeaderUspOut24" class="table table-bordered table-striped">
          <thead>
          <tr>
            <th>No TPN Out</th>
            <th>Tanggal</th>
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trHeaderTpkUspOut24Destroy.del') }}" method="post">
                  {{ csrf_field() }}
