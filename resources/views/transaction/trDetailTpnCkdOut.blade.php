...
{{-- <section class="content-header">
  <div class="container-fluid">
    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" action="{{ route('trDetailTpnCkdOut.add') }}" method="POST">
         @csrf
        ...
        <input type="hidden" name="hph" id="hph" value="CKD">
        <div class="card-body">          
          <div class="row">
            <div class="col-sm-3">
              ...
              <div class="form-group">
                <label>No Batang</label>
                  <select class="form-control select2" name="no_btg" id="no_btg" style="width: 100%;">
                    <option selected="selected">-- Pilih No Btg --</option>
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trDetailTpnCkdOut.del') }}" method="post">
                  {{ csrf_field() }}
