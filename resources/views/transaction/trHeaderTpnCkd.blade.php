...
<!-- Content Header (Page header) -->
    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" action="{{ route('trHeaderTpnCkd.add') }}" method="POST">
         @csrf        
        <div class="card-body">          
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                <label>No TPN</label>
                  <input type="text" class="form-control" id="no_tpn" name="no_tpn" placeholder="" value="TPN/CKD/{{ App\Http\Controllers\UserController::getNewNoTpn('001'); }}">
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
    ...
    <div class="card">
      <!-- /.card-header -->
      <div class="card-body">
        <table id="trHeaderCkd" class="table table-bordered table-striped">
          <thead>
          <tr>
            <th>No</th>
            <th>Tanggal</th>
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trHeaderTpnCkdDestroy.del') }}" method="post">
                  {{ csrf_field() }}
