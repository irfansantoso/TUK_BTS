...
<!-- Content Header (Page header) -->
    ...
    <div class="card card-info">
      ...
      <form class="form-horizontal" action="{{ route('trHeaderTayanOutTongkang.add') }}" method="POST">
         @csrf        
        <div class="card-body">          
          <div class="row">
            <div class="col-sm-3">
              <div class="form-group">
                <label>No TPN</label>
                  <input type="text" class="form-control" id="no_tpn_out" name="no_tpn_out" placeholder="" value="LTA/GAB/{{ App\Http\Controllers\UserController::getNewNoTpkOut('740'); }}-OUT">
              </div>
            </div>
            <div class="col-sm-2">
              <div class="form-group">
            ...
            <div class="col-sm-2">
              <div class="form-group">
                <label>Lokasi</label>                
                  <input type="text" class="form-control" name="" value="Tayan" disabled>
            ...
            <div class="col-sm-3">
              <div class="form-group">
                <label>No Loglist</label>
                  <input type="text" class="form-control" id="no_loglist" name="no_loglist" placeholder="" value="TKG/GAB/{{ App\Http\Controllers\UserController::getNewNoTkg('800'); }}-IN" readonly>
              </div>
            </div>
          </div>
        <!-- /.card-body -->
    ...
    <div class="card">
      <!-- /.card-header -->
      <div class="card-body">
        <table id="trHeaderTayanOutTongkang" class="table table-bordered table-striped">
          <thead>
          <tr>
            <th>No TPN Out</th>
            <th>Tanggal</th>
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('trHeaderTayanOutTongkangDestroy.del') }}" method="post">
                  {{ csrf_field() }}
